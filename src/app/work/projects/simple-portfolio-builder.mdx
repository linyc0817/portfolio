...
summary: "Developed a Retrieval-Augmented Generation (RAG) chatbot to answer graduate-related FAQ using both local document retrieval and LLM-based reasoning."
images:
...
![Flow diagram showing how the chatbot switches between RAG and GPT modes](/images/projects/project-04/system-flow.png)
